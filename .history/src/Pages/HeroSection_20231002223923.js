...
export default function Header() {
  return (
      <div className="flex flex-col md:flex-row mx-auto align-center justify-center mt-14">
        <div className="w-full flex-col">
            <h1 className=" text-4xl md:text-8xl font-black">WELCOME TO MY WEBSITE!</h1>
            <p>
