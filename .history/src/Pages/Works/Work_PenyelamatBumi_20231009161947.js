      ...
      <div className="flex flex-col gap-10 px-5 md:px-[400px] mt-10">
        <div>
          <p>
            ...
            Teknologi Informasi Dan Komunikasi is a competition aimed to improve and
            guide students across Indonesia so that they will
            be able to lead a change in the national's tech sector. Each team consists of
            three participants, with each competing on different section. Me and my friend at the time decided to join the game development section
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            direction and assets making such as the enemy unit.
          </p>
          <p>
