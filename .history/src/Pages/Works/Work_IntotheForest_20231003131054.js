  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-10 px-5 md:px-[400px] mt-10">
        ...
        <div>
          <h2 className="text-2xl font-bold md:mb-14">
          ...
          <p>
                    ...
                    <h2 className="text-3xl font-bold">Unit</h2>
                    ...
                    <h2 className="text-3xl font-bold">NPC Companion</h2>
                    <p>
                        <ul>
                            <li>Movement</li>
                    ...
                    <h2 className="text-3xl font-bold">Enemy</h2>
                    <p>
                        <ul>
                            <li>Movement</li>
