...
export function WorkAlterland(){
    ...
    return(
        <div>
            ...
            <br/>
            <div className='flex flex-col gap-10 px-5 justify-center align-center mx-auto'>
                    <div>
                        <p>
                    ...
                    <div>
                        <h2 className='text-5xl font-bold'><span className='highlight'>Research</span></h2>
                    ...
                    <div>
                        <h2 className='text-5xl font-bold'><span className='highlight'>Modelling</span></h2>
                    ...
                    <div>
                        <h2 className='text-5xl font-bold'><span className='highlight'>Iterate</span></h2>
                    ...
                    <div>
                        <h2 className='text-5xl font-bold'><span className='highlight'>Result</span></h2>
