    ...
    return(
        <div>
            ...
            <div className='flex flex-col gap-10 px-5'>
                    ...
                    <div>
                        <h2><span className='highlight'>Research</span></h2>
                    ...
                    <div>
                        <h2><span className='highlight'>Modelling</span></h2>
                        ...
                        <img src={LevelIllustration} alt="Level" className='p-10'/>
                        <p>
                    ...
                    <div>
                        <h2><span className='highlight'>Iterate</span></h2>
                        ...
                        <img src={ComparisonIllustration} alt="Comparison" />
                    </div>
                    <div>
                        ...
                        <img src={MayorsIllustration} alt="Mayor" />
                    </div>
