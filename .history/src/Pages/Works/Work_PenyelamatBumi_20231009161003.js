      ...
      <div className="flex flex-col gap-10 px-5 md:px-[400px] mt-10">
        <div>
          <p>
            ...
            Teknologi Informasi Dan Komunikasi is a programme aimed to improve
            the competency and guide student across Indonesia to that they will
            be able to lead a change in the local tech sector.
          </p>
        </div>
