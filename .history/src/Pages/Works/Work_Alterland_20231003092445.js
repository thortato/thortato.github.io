...
export function WorkAlterland() {
  return (
    <div>
      ...
      {/* Image */}
      <img
        className="brightness-75 w-full md:h-96"
        src={HeroIllustration}
        alt="Hero Illustration"
      />

      {/* Text */}
      <div className="absolute top-20 left-0 right-0 text-center text-white text-6xl">
        <h1 className="text-shadow-lg">Alterland</h1>
        <p className="text-shadow-lg">City Building Game</p>
        <p className="text-shadow-lg">January 2022 - May 2022</p>
      </div>
    </div>
      {/* <img
        className="brightness-75 w-full h-96"
        src={HeroIllustration}
        alt="Hero Illustration"
      />
      <div className="absolute top-20 mx-auto  text-center text-6xl">
        <h1 className="text-white"> Alterland</h1>
        <p>City Building Game</p>
        <p>January 2022 - May 2022</p>
      </div>
      <br /> */}
      <div className="flex flex-col gap-10 px-5 md:px-[400px]">
        <div>
          <p>
            At the start of 2022, the popularity of NFT and crypto based game
            have skyrocketed like never before. My then agency, Renderkin Studio
            decided to follow the trend to explore what the technology can do.
        ...
        <div>
          ...
          <img src={MayorsIllustration} alt="Mayor" className="p-5" />
        </div>
      </div>
    </div>
  );
