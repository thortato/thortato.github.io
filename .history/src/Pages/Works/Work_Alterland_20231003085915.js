...
export function WorkAlterland(){
    ...
    return(
        <div>
            <div className=' h-1/2 md:h-[100px]'>
                <img className='brightness-75 w-screen' src={HeroIllustration} alt="Hero Illustration" />
                <div className=''>
                    <h1> Alterland</h1>
            ...
            <div className='flex flex-col gap-10 px-5 md:px-[400px]'>
                    ...
                    <div>
                        <h2 className='text-3xl font-bold md:mb-14'><span className='highlight'>Research</span></h2>
                    ...
                    <div>
                        <h2 className='text-3xl font-bold md:mb-14'><span className='highlight'>Modelling</span></h2>
                    ...
                    <div>
                        <h2 className='text-3xl font-bold md:mb-14'><span className='highlight'>Iterate</span></h2>
                    ...
                    <div>
                        <h2 className='text-3xl font-bold md:mb-14'><span className='highlight'>Result</span></h2>
