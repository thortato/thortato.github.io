import "./works.css";
import ItFIllustration from "./../../Assets/Image/Hero_ItF.png";
import ItFImage from './../../Assets/Image/ItFImage.png';
...
export function WorkIntotheForest() {
  return (
    <div>
      ...
      <div className="flex flex-col gap-10 px-5 mx-auto md:px-[400px] items-center mt-10">
        <div>
          <p>
        ...
        <div>
          ...
          <p>
            ...
            type of units in the game, Player, NPC Companion, and Enemy. These
            units are derivatives from the class Unit.
          </p>
        ...
        <div>
          ...
          <p>
            ...
            I was able to finish the game and propose it as my final year project
