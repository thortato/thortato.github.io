...
export default function About(){
    ...
    return (
        <div className='flex flex-col-reverse md:flex-row items-center justify-center align-center gap-6 md:px-40'>
            <div className='flex-1 mx-auto'>
                <img className='rounded-full drop-shadow-xl' src={ProfilePicture} alt="Profile" />
            </div>
